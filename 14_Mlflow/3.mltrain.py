...
def parse_args():
    ...
    p.add_argument("--csv", default="data/wine_data.csv", help="Path to CSV (default: data/wine_data.csv)")
...
def main():
    ...
    tracking_uri = os.getenv("MLFLOW_TRACKING_URI", "52.207.241.237:5000")
    ...
    with mlflow.start_run(run_name=args.run) as run:
        ...
        # mlflow.sklearn.log_model(model1, "rf_model")
        # mlflow.sklearn.log_model(model2, "xgb_model")
